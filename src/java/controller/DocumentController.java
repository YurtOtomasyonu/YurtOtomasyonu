...
public class DocumentController extends BaseBean implements Serializable, Validator {
    ...
    private final String uploadTo = "C:\\Users\\Onur ASLAN\\Documents\\NetBeansProjects\\YS\\upload\\";
    ...
    public void upload() {
        try {
            ...
            File newFile = new File("C:\\Users\\Onur ASLAN\\Documents\\NetBeansProjects\\YS\\upload\\" + a + "." + extension);
            f.renameTo(newFile);
